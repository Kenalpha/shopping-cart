...
cart_checkout(); //calling this function
...
$("#admn_lg").click(function(event){
     event.preventDefault();
     var email = $("#admn_email").val();
     var pass = $("#admn_pss").val();

     $.ajax({
            url     :"admn_lg.php",
            method  :"POST",
            data    : {admnLogin:1, admnEmail:email ,admnPassword:pass},
            success :function(data){
              if (data == "true") {
                window.location.href = "index.php";
              }else{
                $("#admn_err_msg").html(data);
              };
          }
     })
  })
