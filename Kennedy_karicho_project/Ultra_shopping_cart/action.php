...
if(isset($_POST["category"])){
  ...
  echo "<div class='nav nav-pills nav-stacked green'>
      ...
      while ($row = mysqli_fetch_array($run_query)) {
          ...
          echo "
            ...
            <div class='thumbnail'>
              ...
              <div class=''>
                <img class='img-responsive' alt='Product' src='product_images/$pro_image' style='width: 160px; height: 250px;' />
              </div>
              <div class=''>
                $.$pro_price.00
...
if (isset($_POST['get_selected_Category']) || isset($_POST['selectBrand']) || isset($_POST['search'])) {
   if (isset($_POST['get_selected_Category'])) {
     ...
     $keyword = security($_POST["keyword"]);
    ...
    if ($count > 0) {
       echo "
         <div class='alert alert-warning'>
          ...
          <b>Product is already added in the cart Continue shopping</b>
        </div>";
    }else{
         ...
         if (isset($_POST["get_cart_product"])) {
            ...
            echo "
               <div class='row'>
                ...
                <div class='col-md-2'><img src='product_images/$pro_image' width=60px height=100></div>
